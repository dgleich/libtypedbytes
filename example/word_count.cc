 ...
 * ------
   ...
   # set HADOOP_STREAMING_JAR to the path to your hadoop streaming jar
   hadoop fs -put ../README.md readme-libtyped-bytes
   hadoop jar $HADOOP_STREAMING_JAR -input readme-libtyped-bytes -output test-wc-cc \
